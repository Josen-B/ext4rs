...
impl File {
    ...
    pub fn read<D>(&mut self, buf: &mut [u8], fs: &mut crate::Ext4FileSystem<D>) -> Ext4Result<usize>
    where
        D: axdriver_block::BlockDriverOps,
    {
        ...
        while bytes_read < buf.len() && offset < self.inode.size {
            ...
            if block_num == 0 {
                ...
                let remaining_in_block = (block_size as usize - block_offset).min(buf.len() - bytes_read);
        ...
        D: BlockDriverOps,
    {
        ...
        while bytes_written < buf.len() {
            ...
            let block_offset = (offset % block_size as u64) as usize;
            let remaining_in_block = (block_size as usize - block_offset).min(buf.len() - bytes_written);
    ...
    /// Truncate the file
    pub fn truncate<D>(&mut self, new_size: u64, fs: &mut crate::Ext4FileSystem<D>) -> Ext4Result<()>
    where
        D: BlockDriverOps,
    {
